...
\begin{center}
  \begin{tabular}{ p{3.75cm}|p{3.75cm}|p{3.75cm}|p{3.75cm} }
    ...
    \includegraphics[width=1.5cm]{CAUSSIN.jpg} & \includegraphics[width=1.5cm]{MONTUELLE.png} & \includegraphics[width=1.5cm]{SCHMIT.jpg} & \includegraphics[height=2cm]{MONTAGNIER.jpg}
  \end{tabular}
\end{center}
...
\begin{wrapfigure}[5]{R}{0.45\textwidth}
\includegraphics[width=0.4\textwidth]{Tisanes2.png}
\end{wrapfigure}
